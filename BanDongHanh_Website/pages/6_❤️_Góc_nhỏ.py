...
/* Loại bỏ khoảng trống dưới Input để sát Button */
.stTextInput {
...
# Tỉ lệ 4 phần cho input, 1.5 phần cho button để input to hơn
cols_input_btn = st.columns([4, 1.5]) 
...
with cols_input_btn[1]:
    # Thêm CSS để căn nút Button thẳng hàng và sát Input
