...
# MODIFIED: Hàm TTS nâng cấp sử dụng Google Cloud, có fallback về gTTS
@st.cache_data
...
# MODIFIED: Hàm gọi AI Gemini với prompt ngắn gọn hơn và có trí nhớ
...
def user_input_callback():
    ...
    if st.session_state.chat_state == CHAT_STATE_TAM_SU_CHAT:
        ...
        set_chat_state(CHAT_STATE_AWAITING_FOLLOWUP)
        ai_history = st.session_state.ai_history[:-1] # Lấy lịch sử trừ tin nhắn cuối
