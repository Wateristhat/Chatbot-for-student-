...
def inject_global_components():
    ...
    # ⚠️ SỬA LỖI: Thay hash(st.current_page_name) bằng page_id đã làm sạch
    if st.button(icon, key=f"global_music_toggle_button_{page_id}"): 
    ...
    # --- KHỐI 2: NHÚNG AUDIO VÀ JS ĐIỀU KHIỂN ---
